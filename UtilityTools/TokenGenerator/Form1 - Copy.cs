...
namespace TokenGenerator
{
    public partial class FormTokenGenerator : Form
    {
        ...
        string qnaJAppCD = "JPSWT";
        string snbJAppCD = "JPSWS";
        string prdJAppCD = "JPRS_PRD_A_COR";
        string qnaJAuthServiceURL = "https://sandbox-auth.livecareer.com/";
        string snbJAuthServiceURL = "https://sandbox-auth.livecareer.com/";
        string prdJuthServiceURL = "https://auth.livecareer.com/";
        string qnaJClientSecret = "d2VnZmVqcHJzMTAwMTE5cmU=";
        string snbJClientSecret = "amNuNDVqcHJzMTAwMTE5c2U=";
        string prdJClientSecret = "------------------------";
